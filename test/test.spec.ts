...
describe('XML Testing', () => {
  it('should return the xml with the simulation part', () => {
    let xml = bpsimdata.toXMLelement("bpsim", bpsimNamespaceURI, true);

    let xmlExpected = '<bpsim:BPSimData xmlns:bpsim="http://www.bpsim.org/schemas/1.0"><bpsim:Scenario name="Scenario1" created="2009-06-15T13:45:30" vendor="Caputo &amp; Lazazzera"><bpsim:ScenarioParameters replication="1" baseTimeUnit="min" baseCurrencyUnit="USD" baseResultFrequencyCumul="false" traceOutput="false" traceFormat="XES"/></bpsim:Scenario><bpsim:Scenario name="Scenario2" vendor="Caputo &amp; Lazazzera"><bpsim:ScenarioParameters replication="10" baseTimeUnit="hour" baseCurrencyUnit="EUR" baseResultFrequencyCumul="false" traceOutput="false" traceFormat="XES"><bpsim:Start><bpsim:BooleanParameter validFor="C1" value="true"/><bpsim:ExpressionParameter result="max" value="XPATH"/><bpsim:EnumParameter><bpsim:BooleanParameter validFor="C1" value="true"/></bpsim:EnumParameter><bpsim:ResultRequest>count</bpsim:ResultRequest></bpsim:Start><bpsim:PropertyParameters><bpsim:Property type="long"><bpsim:FloatingParameter result="max" value="2.1" timeUnit="year"/><bpsim:UserDistribution discrete="true"><bpsim:UserDistributionDataPoint probability="0.8"><bpsim:FloatingParameter result="max" value="2.1" timeUnit="year"/><bpsim:TriangularDistribution instance="Triangolo" min="2"/></bpsim:UserDistributionDataPoint></bpsim:UserDistribution><bpsim:TriangularDistribution instance="Triangolo" min="2"/></bpsim:Property><bpsim:Property><bpsim:BooleanParameter instance="Ciao" value="false"/><bpsim:NumericParameter result="max" value="9" timeUnit="year"/></bpsim:Property></bpsim:PropertyParameters></bpsim:ScenarioParameters><bpsim:ElementParameters id="el1" elementRef="ref_XXX"><bpsim:CostParameters><bpsim:FixedCost><bpsim:GammaDistribution scale="2"/><bpsim:LogNormalDistribution mean="0.7"/></bpsim:FixedCost></bpsim:CostParameters><bpsim:PropertyParameters><bpsim:Property type="long"><bpsim:FloatingParameter result="max" value="2.9" timeUnit="year"/><bpsim:UserDistribution discrete="true"><bpsim:UserDistributionDataPoint probability="0.1"><bpsim:FloatingParameter result="max" value="2.9" timeUnit="year"/><bpsim:TriangularDistribution instance="Cerchio" max="1"/></bpsim:UserDistributionDataPoint></bpsim:UserDistribution><bpsim:TriangularDistribution instance="Cerchio" max="1"/></bpsim:Property></bpsim:PropertyParameters></bpsim:ElementParameters><bpsim:ElementParameters id="el2" elementRef="ref_YYY"><bpsim:TimeParameters><bpsim:LagTime><bpsim:GammaDistribution scale="2"/><bpsim:LogNormalDistribution mean="0.7"/></bpsim:LagTime></bpsim:TimeParameters><bpsim:ControlParameters><bpsim:TriggerCount><bpsim:BooleanParameter value="true"/></bpsim:TriggerCount></bpsim:ControlParameters><bpsim:ResourceParameters><bpsim:Role><bpsim:GammaDistribution scale="2"/><bpsim:LogNormalDistribution mean="0.7"/></bpsim:Role><bpsim:Role><bpsim:BooleanParameter value="true"/></bpsim:Role></bpsim:ResourceParameters><bpsim:PriorityParameters><bpsim:Interruptible><bpsim:GammaDistribution scale="2"/><bpsim:LogNormalDistribution mean="0.7"/></bpsim:Interruptible></bpsim:PriorityParameters></bpsim:ElementParameters><bpsim:VendorExtension name="Vendor XXXX" value="&lt;ciao&gt;"/><bpsim:VendorExtension name="Vendor YYYY" value="&lt;hello&gt;"/><bpsim:Calendar id="C1" name="Calendario attivo">TEST1</bpsim:Calendar><bpsim:Calendar id="C2" name="Calendario vecchio">TEST2</bpsim:Calendar><bpsim:Calendar id="C3" name="Calendario non valido">TEST3</bpsim:Calendar><bpsim:Calendar id="C1"/></bpsim:Scenario></bpsim:BPSimData>'
    expect(xml == xmlExpected)
